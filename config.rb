...
# proxy course.yml files to course.html 
data.courses.each do |_filename, course|
  # course is an array: [filename, {data}]
  proxy "/course/#{course[:title].parameterize}/index.html", "course.html", 
